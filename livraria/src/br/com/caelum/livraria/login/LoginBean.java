...
import br.com.caelum.livraria.service.UsuerService;
...
public class LoginBean {
	...
	public String efetuaLogin() {
		...
		Usuario usuarioEncontrado = this.service.findByLoginWithCriteria(usuario.getLogin());
